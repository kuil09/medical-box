...
Do not model individual medicine packages as rough standalone WebGL primitives
or floating labels. The physical metaphor belongs to the box structure; the
...
Settings must remain a separate screen. Inventory sharing must always be
