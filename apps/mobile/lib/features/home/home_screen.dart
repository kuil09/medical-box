                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: MedicalBoxColors.sky.withValues(alpha: 0.45),
                        borderRadius: BorderRadius.circular(16),
                      ),
                      child: const Text(
                        '제품명·사용기한·공식 제품 정보 링크를 기본으로 포함해요.',
...
class _InteractiveMedicineTrayState extends State<_InteractiveMedicineTray> {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      expanded: _isOpen,
      label: _isOpen
          ? '열린 공용 의약품 구급상자, 의약품 ${widget.items.length}종이 보임'
          : '닫힌 공용 의약품 구급상자',
      child: Column(
        children: [
          _MedicineBoxShell(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          '상자 안 ${widget.items.length}종 · 보이는 의약품을 선택하세요',
                          style: const TextStyle(
                            color: MedicalBoxColors.muted,
                            fontSize: 11,
                            fontWeight: FontWeight.w800,
                  ...
                  if (widget.items.length > 4)
                    SizedBox(
                      ...
                      child: OutlinedButton(
                        ...
                        child: Text('보관약 ${widget.items.length}종 모두 보기'),
                      ),
                    ),
                ],
              ),
      ...
      child: Stack(
        ...
        children: [
          ...
          AnimatedPositioned(
            ...
            child: Semantics(
              button: true,
              label: isOpen ? '공용 구급상자 닫기' : '공용 구급상자 열기, 의약품 ${items.length}종',
                ...
                child: AnimatedContainer(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 9),
                      Text(
                        isOpen ? '열림 · 눌러서 닫기' : '${items.length}종 · 눌러서 열기',
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const Expanded(
          child: Text(
            '가족 이름·메모·방문일은 이 기기 밖으로 전송하지 않아요.',
